<?php /*a:2:{s:52:"F:\www\kefu\application\admin\view\groups\index.html";i:1571111643;s:53:"F:\www\kefu\application\admin\view\layout\header.html";i:1571110702;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript">
    function initTable() {
        ...
        $("#cusTable").bootstrapTable({
            ...
            url: "<?php echo url('groups/index'); ?>", //获取数据的地址
            striped: true,  //表格显示条纹
    ...
    function userGroup(id){
        layer.confirm('确认删除此分组?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON("<?php echo url('groups/delGroup'); ?>", {'id' : id}, function(res){
                if(1 == res.code){
