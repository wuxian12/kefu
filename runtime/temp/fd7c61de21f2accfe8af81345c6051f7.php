<?php /*a:2:{s:55:"F:\www\kefu\application\admin\view\words\edit_word.html";i:1571112159;s:53:"F:\www\kefu\application\admin\view\layout\header.html";i:1571110702;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="col-sm-8">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t layui-form" id="commentForm" method="post" action="<?php echo url('words/editWord'); ?>">
                        <input type="hidden" name="id" value="<?php echo htmlentities($info['id']); ?>"/>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">常用语内容：</label>
                            <div class="input-group col-sm-4">
                                <textarea class="form-control" name="content" required="" aria-required="true" style="width: 400px;height: 150px;resize:none"><?php echo htmlentities($info['content']); ?></textarea>
                            </div>
                        </div>
