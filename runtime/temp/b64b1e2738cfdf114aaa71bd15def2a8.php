<?php /*a:2:{s:57:"F:\www\kefu\application\admin\view\groups\edit_group.html";i:1571111716;s:53:"F:\www\kefu\application\admin\view\layout\header.html";i:1571110702;}*/ ?>
<!DOCTYPE html>
<html>
<head>
                    ...
                    <form class="form-horizontal m-t layui-form" id="commentForm" method="post" action="<?php echo url('groups/editgroup'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input class="form-control" name="name" required="" aria-required="true" value="<?php echo htmlentities($info['name']); ?>"/>
                            </div>
                        </div>
