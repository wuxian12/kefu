<?php /*a:2:{s:55:"F:\www\kefu\application\admin\view\users\edit_user.html";i:1571111210;s:53:"F:\www\kefu\application\admin\view\layout\header.html";i:1571110702;}*/ ?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t layui-form" id="commentForm" method="post" action="<?php echo url('users/edituser'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" id="group_id" name="group_id" value="<?php echo htmlentities($info['group_id']); ?>"/>
                            <div class="input-group col-sm-4 layui-form">
                                <select lay-verify="required" lay-filter="group">
                                    ...
                                    <option value="<?php echo htmlentities($vo['id']); ?>" <?php if($vo['id'] == $info['group_id']): ?>selected<?php endif; ?>><?php echo htmlentities($vo['name']); ?></option>
                        ...
                        <div class="form-group layui-form-item form-inline" style="height: 60px;">
                            ...
                            <div class="input-group col-sm-3" id="avatar">
                                <img src="<?php echo htmlentities($info['user_avatar']); ?>" width="40px" height="40px"/>
                            </div>
                        </div>
