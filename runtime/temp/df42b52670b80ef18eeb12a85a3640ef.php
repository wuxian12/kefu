<?php /*a:4:{s:45:"F:\www\kefu\application\admin\view\index.html";i:1571109066;s:53:"F:\www\kefu\application\admin\view\layout\header.html";i:1571110702;s:44:"F:\www\kefu\application\admin\view\menu.html";i:1570786354;s:53:"F:\www\kefu\application\admin\view\layout\footer.html";i:1571106784;}*/ ?>
<!DOCTYPE html>
<html>
<head>
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="/static/admin/images/profile_small.jpg"/></span>
...
<li class="menu">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer">
            <div class="pull-right">&copy; 2018-<?php echo date('Y');?> <a href="https://github.com/shmilylbelva/laykefu" target="_blank">laykefu</a> <?php echo htmlentities($version); ?>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
