<?php /*a:2:{s:52:"F:\www\kefu\application\admin\view\system\reply.html";i:1571119584;s:53:"F:\www\kefu\application\admin\view\layout\header.html";i:1571110702;}*/ ?>
<!DOCTYPE html>
<html>
<head>
                    ...
                    <form class="form-horizontal m-t layui-form" id="commentForm" method="post" action="<?php echo url('system/reply'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <textarea class="form-control" name="word" required="" aria-required="true" style="width: 400px;height: 150px;resize:none"><?php echo htmlentities($info['word']); ?></textarea>
                            </div>
                        </div>
