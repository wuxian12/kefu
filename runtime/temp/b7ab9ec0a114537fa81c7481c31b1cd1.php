<?php /*a:2:{s:51:"F:\www\kefu\application\admin\view\words\index.html";i:1571112150;s:53:"F:\www\kefu\application\admin\view\layout\header.html";i:1571110702;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript">
    function initTable() {
        ...
        $("#cusTable").bootstrapTable({
            ...
            url: "<?php echo url('words/index'); ?>", //获取数据的地址
            striped: true,  //表格显示条纹
    ...
    function userDel(id){
        layer.confirm('确认删除此常用语?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON("<?php echo url('words/delWord'); ?>", {'id' : id}, function(res){
                if(1 == res.code){
